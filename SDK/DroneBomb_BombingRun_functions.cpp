...
// BlueprintGeneratedClass DroneBomb_BombingRun.DroneBomb_BombingRun_C
// (None)

class UClass* UDroneBomb_BombingRun_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("DroneBomb_BombingRun_C");

	return Clss;
}


// DroneBomb_BombingRun_C DroneBomb_BombingRun.Default__DroneBomb_BombingRun_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UDroneBomb_BombingRun_C* UDroneBomb_BombingRun_C::GetDefaultObj()
{
	static class UDroneBomb_BombingRun_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UDroneBomb_BombingRun_C*>(UDroneBomb_BombingRun_C::StaticClass()->DefaultObject);

	return Default;
}


// Function DroneBomb_BombingRun.DroneBomb_BombingRun_C.OnSlottedEvent
...
void UDroneBomb_BombingRun_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("DroneBomb_BombingRun_C", "OnSlottedEvent");

	Params::UDroneBomb_BombingRun_C_OnSlottedEvent_Params Parms{};
...
// Function DroneBomb_BombingRun.DroneBomb_BombingRun_C.OnUnslottedEvent
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
...
void UDroneBomb_BombingRun_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("DroneBomb_BombingRun_C", "OnUnslottedEvent");

	Params::UDroneBomb_BombingRun_C_OnUnslottedEvent_Params Parms{};
...
// Function DroneBomb_BombingRun.DroneBomb_BombingRun_C.OnUpgradeRolledDataChangedEvent
...
void UDroneBomb_BombingRun_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("DroneBomb_BombingRun_C", "OnUpgradeRolledDataChangedEvent");

	Params::UDroneBomb_BombingRun_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
// Function DroneBomb_BombingRun.DroneBomb_BombingRun_C.ExecuteUbergraph_DroneBomb_BombingRun
...
void UDroneBomb_BombingRun_C::ExecuteUbergraph_DroneBomb_BombingRun(int32 EntryPoint, class UQtnUpgradeSlot* K2Node_Event_OwningSlot, const struct FQtnRolledUpgradeData& K2Node_Event_PreviousRolledData, const struct FQtnRolledUpgradeData& K2Node_Event_NewRolledData, class UQtnUpgradeSlot* K2Node_Event_PreviousSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue, float CallFunc_GetValueOfUpgrade_ReturnValue, class UTimeBombVerb_C* K2Node_DynamicCast_AsTime_Bomb_Verb, bool K2Node_DynamicCast_bSuccess, float CallFunc_GetValueOfUpgrade_ReturnValue_1, int32 CallFunc_FTrunc_ReturnValue, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue_1, class UQtnUpgradeSlot* K2Node_Event_TargetSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData_1, bool K2Node_Event_LoadedRunProgress, class UTimeBombVerb_C* K2Node_DynamicCast_AsTime_Bomb_Verb_1, bool K2Node_DynamicCast_bSuccess_1, float CallFunc_GetValueOfUpgrade_ReturnValue_2, float CallFunc_GetValueOfUpgrade_ReturnValue_3, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue_2, int32 CallFunc_FTrunc_ReturnValue_1, class UTimeBombVerb_C* K2Node_DynamicCast_AsTime_Bomb_Verb_2, bool K2Node_DynamicCast_bSuccess_2)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("DroneBomb_BombingRun_C", "ExecuteUbergraph_DroneBomb_BombingRun");

	Params::UDroneBomb_BombingRun_C_ExecuteUbergraph_DroneBomb_BombingRun_Params Parms{};
