...
class UClass* ALevelUp_FX_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LevelUp_FX_C");

	return Clss;
}


// LevelUp_FX_C LevelUp_FX.Default__LevelUp_FX_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ALevelUp_FX_C* ALevelUp_FX_C::GetDefaultObj()
{
	static class ALevelUp_FX_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ALevelUp_FX_C*>(ALevelUp_FX_C::StaticClass()->DefaultObject);

	return Default;
}


// Function LevelUp_FX.LevelUp_FX_C.OrientEffect
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                      Actor                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ALevelUp_FX_C::OrientEffect(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("LevelUp_FX_C", "OrientEffect");

	Params::ALevelUp_FX_C_OrientEffect_Params Parms{};
...
// Function LevelUp_FX.LevelUp_FX_C.ExecuteUbergraph_LevelUp_FX
