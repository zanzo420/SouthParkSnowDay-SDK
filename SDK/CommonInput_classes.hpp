...
{
public:
	uint8                                        Pad_D10[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D17[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         bProcessInputChanges;                              // 0xF1(0x1)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
