...
class UFTUX_PissedOff_ModalWidget_C : public UQtnUserWidget
{
public:
	...
	static class UFTUX_PissedOff_ModalWidget_C* GetDefaultObj();

	void SetupImage(class AQtnPlayerController* CallFunc_GetOwningPlayerController_ReturnValue, class UFTUX_PissedOff_Image_C* CallFunc_Create_ReturnValue);
