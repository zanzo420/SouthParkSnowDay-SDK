...
// BlueprintGeneratedClass DroneBomb_PlayerFollowing.DroneBomb_PlayerFollowing_C
// (None)

class UClass* UDroneBomb_PlayerFollowing_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("DroneBomb_PlayerFollowing_C");

	return Clss;
}


// DroneBomb_PlayerFollowing_C DroneBomb_PlayerFollowing.Default__DroneBomb_PlayerFollowing_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UDroneBomb_PlayerFollowing_C* UDroneBomb_PlayerFollowing_C::GetDefaultObj()
{
	static class UDroneBomb_PlayerFollowing_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UDroneBomb_PlayerFollowing_C*>(UDroneBomb_PlayerFollowing_C::StaticClass()->DefaultObject);

	return Default;
}


// Function DroneBomb_PlayerFollowing.DroneBomb_PlayerFollowing_C.OnSlottedEvent
...
void UDroneBomb_PlayerFollowing_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("DroneBomb_PlayerFollowing_C", "OnSlottedEvent");

	Params::UDroneBomb_PlayerFollowing_C_OnSlottedEvent_Params Parms{};
...
// Function DroneBomb_PlayerFollowing.DroneBomb_PlayerFollowing_C.OnUnslottedEvent
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
...
void UDroneBomb_PlayerFollowing_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("DroneBomb_PlayerFollowing_C", "OnUnslottedEvent");

	Params::UDroneBomb_PlayerFollowing_C_OnUnslottedEvent_Params Parms{};
...
// Function DroneBomb_PlayerFollowing.DroneBomb_PlayerFollowing_C.OnUpgradeRolledDataChangedEvent
...
void UDroneBomb_PlayerFollowing_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("DroneBomb_PlayerFollowing_C", "OnUpgradeRolledDataChangedEvent");

	Params::UDroneBomb_PlayerFollowing_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
// Function DroneBomb_PlayerFollowing.DroneBomb_PlayerFollowing_C.ExecuteUbergraph_DroneBomb_PlayerFollowing
...
void UDroneBomb_PlayerFollowing_C::ExecuteUbergraph_DroneBomb_PlayerFollowing(int32 EntryPoint, class UQtnUpgradeSlot* K2Node_Event_OwningSlot, const struct FQtnRolledUpgradeData& K2Node_Event_PreviousRolledData, const struct FQtnRolledUpgradeData& K2Node_Event_NewRolledData, float CallFunc_GetValueOfUpgrade_ReturnValue, float CallFunc_GetValueOfUpgrade_ReturnValue_1, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue, class UQtnUpgradeSlot* K2Node_Event_TargetSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData_1, bool K2Node_Event_LoadedRunProgress, class UTimeBombVerb_C* K2Node_DynamicCast_AsTime_Bomb_Verb, bool K2Node_DynamicCast_bSuccess, float CallFunc_GetValueOfUpgrade_ReturnValue_2, float CallFunc_GetValueOfUpgrade_ReturnValue_3, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue_1, class UQtnUpgradeSlot* K2Node_Event_PreviousSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData, class UTimeBombVerb_C* K2Node_DynamicCast_AsTime_Bomb_Verb_1, bool K2Node_DynamicCast_bSuccess_1, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue_2, class UTimeBombVerb_C* K2Node_DynamicCast_AsTime_Bomb_Verb_2, bool K2Node_DynamicCast_bSuccess_2)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("DroneBomb_PlayerFollowing_C", "ExecuteUbergraph_DroneBomb_PlayerFollowing");

	Params::UDroneBomb_PlayerFollowing_C_ExecuteUbergraph_DroneBomb_PlayerFollowing_Params Parms{};
