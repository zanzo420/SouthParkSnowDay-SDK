...
struct UGravityBomb_AbsoluteZero_C_OnSlottedEvent_Params
{
public:
...
struct UGravityBomb_AbsoluteZero_C_OnUnslottedEvent_Params
{
public:
...
struct UGravityBomb_AbsoluteZero_C_OnUpgradeRolledDataChangedEvent_Params
{
public:
...
struct UGravityBomb_AbsoluteZero_C_ExecuteUbergraph_GravityBomb_AbsoluteZero_Params
{
public:
	...
	float                                        CallFunc_GetValueOfUpgrade_ReturnValue;            // 0x110(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_HasAuthority_ReturnValue_1;               // 0x114(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_75A7[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UQtnVerb*                              CallFunc_GetOwningVerb_ReturnValue_1;              // 0x118(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_GetValueOfUpgrade_ReturnValue_1;          // 0x1F8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_75A9[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class AQtnBodyPawn*                          CallFunc_GetOwningBodyPawn_ReturnValue_2;          // 0x200(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UQtnVerb*                              CallFunc_GetOwningVerb_ReturnValue_2;              // 0x208(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_HasAuthority_ReturnValue_2;               // 0x210(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_75AA[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UGravityBombVerb_C*                    K2Node_DynamicCast_AsGravity_Bomb_Verb_2;          // 0x218(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
