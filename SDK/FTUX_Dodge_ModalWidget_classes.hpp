...
class UFTUX_Dodge_ModalWidget_C : public UQtnUserWidget
{
public:
	...
	static class UFTUX_Dodge_ModalWidget_C* GetDefaultObj();

	void SetupImage(class AQtnPlayerController* CallFunc_GetOwningPlayerController_ReturnValue, class UFTUX_Dodge_Image_C* CallFunc_Create_ReturnValue);
