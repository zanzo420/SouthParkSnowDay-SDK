...
class UClass* UCheatSuperSize_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CheatSuperSize_C");

	return Clss;
}


// CheatSuperSize_C CheatSuperSize.Default__CheatSuperSize_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCheatSuperSize_C* UCheatSuperSize_C::GetDefaultObj()
{
	static class UCheatSuperSize_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCheatSuperSize_C*>(UCheatSuperSize_C::StaticClass()->DefaultObject);

	return Default;
}


// Function CheatSuperSize.CheatSuperSize_C.OnStatusEffectTick
// (Event, Protected, BlueprintEvent)
// Parameters:
// float                              DeltaSeconds                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCheatSuperSize_C::OnStatusEffectTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("CheatSuperSize_C", "OnStatusEffectTick");

	Params::UCheatSuperSize_C_OnStatusEffectTick_Params Parms{};
...
// Function CheatSuperSize.CheatSuperSize_C.OnStatusEffectEnd
// (Event, Protected, BlueprintEvent)
// Parameters:
...
void UCheatSuperSize_C::OnStatusEffectEnd(class AActor* AffectedActor, class AQtnPawn* Instigator, bool IsActorBeingDestroyed)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("CheatSuperSize_C", "OnStatusEffectEnd");

	Params::UCheatSuperSize_C_OnStatusEffectEnd_Params Parms{};
...
// Function CheatSuperSize.CheatSuperSize_C.OnStatusEffectBegin
// (Event, Protected, BlueprintEvent)
// Parameters:
// class AActor*                      AffectedActor                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AQtnPawn*                    Instigator                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCheatSuperSize_C::OnStatusEffectBegin(class AActor* AffectedActor, class AQtnPawn* Instigator)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("CheatSuperSize_C", "OnStatusEffectBegin");

	Params::UCheatSuperSize_C_OnStatusEffectBegin_Params Parms{};
...
// Function CheatSuperSize.CheatSuperSize_C.ExecuteUbergraph_CheatSuperSize
