...
class UFTUX_Bots_ModalWidget_C : public UQtnUserWidget
{
public:
	...
	static class UFTUX_Bots_ModalWidget_C* GetDefaultObj();

	void SetupImage(class AQtnPlayerController* CallFunc_GetOwningPlayerController_ReturnValue, class UFTUX_Bots_Image_C* CallFunc_Create_ReturnValue);
