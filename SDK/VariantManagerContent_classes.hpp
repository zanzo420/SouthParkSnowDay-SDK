...
public:
	...
	uint8                                        Pad_D71[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	struct FSoftObjectPath                       LevelVariantSets;                                  // 0x250(0x18)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class UClass*, class ULevelVariantSetsFunctionDirector*> DirectorInstances;                                 // 0x268(0x50)(Transient, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_DB8[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DBE[0x6F];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	class USceneComponent*                       SceneComponent;                                    // 0x268(0x8)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                        LastSelectedOption;                                // 0x270(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                        Pad_E2B[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
