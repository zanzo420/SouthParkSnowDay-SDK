...
class UClass* UUpgrade_Tower_MineField_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Upgrade_Tower_MineField_C");

	return Clss;
}


// Upgrade_Tower_MineField_C Upgrade_Tower_MineField.Default__Upgrade_Tower_MineField_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUpgrade_Tower_MineField_C* UUpgrade_Tower_MineField_C::GetDefaultObj()
{
	static class UUpgrade_Tower_MineField_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUpgrade_Tower_MineField_C*>(UUpgrade_Tower_MineField_C::StaticClass()->DefaultObject);
...
void UUpgrade_Tower_MineField_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_MineField_C", "OnSlottedEvent");

	Params::UUpgrade_Tower_MineField_C_OnSlottedEvent_Params Parms{};
...
void UUpgrade_Tower_MineField_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_MineField_C", "OnUnslottedEvent");

	Params::UUpgrade_Tower_MineField_C_OnUnslottedEvent_Params Parms{};
...
void UUpgrade_Tower_MineField_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_MineField_C", "OnUpgradeRolledDataChangedEvent");

	Params::UUpgrade_Tower_MineField_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
