...
{
public:
	class UHoudiniPointCache*                    HoudiniPointCacheAsset;                            // 0x38(0x8)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
