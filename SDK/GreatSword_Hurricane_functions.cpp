...
class UClass* UGreatSword_Hurricane_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GreatSword_Hurricane_C");

	return Clss;
}


// GreatSword_Hurricane_C GreatSword_Hurricane.Default__GreatSword_Hurricane_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGreatSword_Hurricane_C* UGreatSword_Hurricane_C::GetDefaultObj()
{
	static class UGreatSword_Hurricane_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGreatSword_Hurricane_C*>(UGreatSword_Hurricane_C::StaticClass()->DefaultObject);

	return Default;
}


// Function GreatSword_Hurricane.GreatSword_Hurricane_C.OnSlottedEvent
...
void UGreatSword_Hurricane_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GreatSword_Hurricane_C", "OnSlottedEvent");

	Params::UGreatSword_Hurricane_C_OnSlottedEvent_Params Parms{};
...
// Function GreatSword_Hurricane.GreatSword_Hurricane_C.OnUnslottedEvent
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
...
void UGreatSword_Hurricane_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GreatSword_Hurricane_C", "OnUnslottedEvent");

	Params::UGreatSword_Hurricane_C_OnUnslottedEvent_Params Parms{};
...
// Function GreatSword_Hurricane.GreatSword_Hurricane_C.OnUpgradeRolledDataChangedEvent
...
void UGreatSword_Hurricane_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GreatSword_Hurricane_C", "OnUpgradeRolledDataChangedEvent");

	Params::UGreatSword_Hurricane_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
// Function GreatSword_Hurricane.GreatSword_Hurricane_C.ExecuteUbergraph_GreatSword_Hurricane
