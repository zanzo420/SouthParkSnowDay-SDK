...
// BlueprintGeneratedClass EnemyUpgrade_Brute.EnemyUpgrade_Brute_C
// (None)

class UClass* UEnemyUpgrade_Brute_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("EnemyUpgrade_Brute_C");

	return Clss;
}


// EnemyUpgrade_Brute_C EnemyUpgrade_Brute.Default__EnemyUpgrade_Brute_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UEnemyUpgrade_Brute_C* UEnemyUpgrade_Brute_C::GetDefaultObj()
{
	static class UEnemyUpgrade_Brute_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UEnemyUpgrade_Brute_C*>(UEnemyUpgrade_Brute_C::StaticClass()->DefaultObject);

	return Default;
}


// Function EnemyUpgrade_Brute.EnemyUpgrade_Brute_C.CanEnemyUpgradeBeRolled
