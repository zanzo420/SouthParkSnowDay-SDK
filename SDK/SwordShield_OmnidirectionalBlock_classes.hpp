...
class USwordShield_OmnidirectionalBlock_C : public UQtnUpgradeArchetype_C
{
public:
	...
	static class USwordShield_OmnidirectionalBlock_C* GetDefaultObj();
