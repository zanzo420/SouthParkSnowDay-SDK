...
{
public:
	uint8                                        Pad_74E[0x1C0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<class UObject*>                       AssetsHotfixedFromIniFiles;                        // 0x218(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_74F[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_753[0x23];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_754[0x16];                                     // Fixing Size After Last Property  [ Dumper-7 ]
