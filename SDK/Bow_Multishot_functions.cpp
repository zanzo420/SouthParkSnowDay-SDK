...
class UClass* UBow_Multishot_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Bow_Multishot_C");

	return Clss;
}


// Bow_Multishot_C Bow_Multishot.Default__Bow_Multishot_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBow_Multishot_C* UBow_Multishot_C::GetDefaultObj()
{
	static class UBow_Multishot_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBow_Multishot_C*>(UBow_Multishot_C::StaticClass()->DefaultObject);
...
void UBow_Multishot_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Bow_Multishot_C", "OnSlottedEvent");

	Params::UBow_Multishot_C_OnSlottedEvent_Params Parms{};
...
void UBow_Multishot_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Bow_Multishot_C", "OnUnslottedEvent");

	Params::UBow_Multishot_C_OnUnslottedEvent_Params Parms{};
...
void UBow_Multishot_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Bow_Multishot_C", "OnUpgradeRolledDataChangedEvent");

	Params::UBow_Multishot_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
