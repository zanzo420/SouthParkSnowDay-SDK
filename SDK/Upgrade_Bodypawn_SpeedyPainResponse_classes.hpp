...
class UUpgrade_Bodypawn_SpeedyPainResponse_C : public UQtnUpgradeArchetype_C
{
public:
	uint8                                        Pad_5C46[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x88(0x8)(ZeroConstructor, Transient, DuplicateTransient)

	static class UClass* StaticClass();
	static class UUpgrade_Bodypawn_SpeedyPainResponse_C* GetDefaultObj();
