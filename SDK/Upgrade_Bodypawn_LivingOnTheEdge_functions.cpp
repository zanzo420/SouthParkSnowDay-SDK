...
class UClass* UUpgrade_Bodypawn_LivingOnTheEdge_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Upgrade_Bodypawn_LivingOnTheEdge_C");

	return Clss;
}


// Upgrade_Bodypawn_LivingOnTheEdge_C Upgrade_Bodypawn_LivingOnTheEdge.Default__Upgrade_Bodypawn_LivingOnTheEdge_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUpgrade_Bodypawn_LivingOnTheEdge_C* UUpgrade_Bodypawn_LivingOnTheEdge_C::GetDefaultObj()
{
	static class UUpgrade_Bodypawn_LivingOnTheEdge_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUpgrade_Bodypawn_LivingOnTheEdge_C*>(UUpgrade_Bodypawn_LivingOnTheEdge_C::StaticClass()->DefaultObject);
...
void UUpgrade_Bodypawn_LivingOnTheEdge_C::CalculateDamageValues(class UQtnUpgradeSlot* OwningSlot, class UQtnVerb* SourceVerb, class AActor* TargetActor, float InBaseDamage, TSubclassOf<class UQtnDamageType> DamageType, float* OutDamageScalar, float* OutBonusDamage, float CallFunc_GetValueOfUpgrade_ReturnValue, class AQtnBodyPawn* CallFunc_GetOwningBodyPawn_ReturnValue, float CallFunc_GetHealth_health, float CallFunc_GetHealth_maxHealth, float CallFunc_MapRangeClamped_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Bodypawn_LivingOnTheEdge_C", "CalculateDamageValues");

	Params::UUpgrade_Bodypawn_LivingOnTheEdge_C_CalculateDamageValues_Params Parms{};
...
void UUpgrade_Bodypawn_LivingOnTheEdge_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Bodypawn_LivingOnTheEdge_C", "OnSlottedEvent");

	Params::UUpgrade_Bodypawn_LivingOnTheEdge_C_OnSlottedEvent_Params Parms{};
...
void UUpgrade_Bodypawn_LivingOnTheEdge_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Bodypawn_LivingOnTheEdge_C", "OnUnslottedEvent");

	Params::UUpgrade_Bodypawn_LivingOnTheEdge_C_OnUnslottedEvent_Params Parms{};
...
void UUpgrade_Bodypawn_LivingOnTheEdge_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Bodypawn_LivingOnTheEdge_C", "OnUpgradeRolledDataChangedEvent");

	Params::UUpgrade_Bodypawn_LivingOnTheEdge_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
void UUpgrade_Bodypawn_LivingOnTheEdge_C::VFXActivation_OnHPIncrease(float AmountIncreased, class UAttribute_Health_C* HealthAttribute)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Bodypawn_LivingOnTheEdge_C", "VFXActivation_OnHPIncrease");

	Params::UUpgrade_Bodypawn_LivingOnTheEdge_C_VFXActivation_OnHPIncrease_Params Parms{};
...
void UUpgrade_Bodypawn_LivingOnTheEdge_C::VFXActivation_OnHPDecrease(float Amount_Decreased, class UAttribute_Health_C* Attribute_Taking_Damage)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Bodypawn_LivingOnTheEdge_C", "VFXActivation_OnHPDecrease");

	Params::UUpgrade_Bodypawn_LivingOnTheEdge_C_VFXActivation_OnHPDecrease_Params Parms{};
