...
// BlueprintGeneratedClass Outcome_PlayerRangedUses.Outcome_PlayerRangedUses_C
// (None)

class UClass* UOutcome_PlayerRangedUses_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Outcome_PlayerRangedUses_C");

	return Clss;
}


// Outcome_PlayerRangedUses_C Outcome_PlayerRangedUses.Default__Outcome_PlayerRangedUses_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UOutcome_PlayerRangedUses_C* UOutcome_PlayerRangedUses_C::GetDefaultObj()
{
	static class UOutcome_PlayerRangedUses_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UOutcome_PlayerRangedUses_C*>(UOutcome_PlayerRangedUses_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Outcome_PlayerRangedUses.Outcome_PlayerRangedUses_C.K2_CalculateOutcome
