...
// BlueprintGeneratedClass FartEscape_TheEggDrop.FartEscape_TheEggDrop_C
// (None)

class UClass* UFartEscape_TheEggDrop_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FartEscape_TheEggDrop_C");

	return Clss;
}


// FartEscape_TheEggDrop_C FartEscape_TheEggDrop.Default__FartEscape_TheEggDrop_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFartEscape_TheEggDrop_C* UFartEscape_TheEggDrop_C::GetDefaultObj()
{
	static class UFartEscape_TheEggDrop_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFartEscape_TheEggDrop_C*>(UFartEscape_TheEggDrop_C::StaticClass()->DefaultObject);

	return Default;
}


// Function FartEscape_TheEggDrop.FartEscape_TheEggDrop_C.OnSlottedEvent
...
void UFartEscape_TheEggDrop_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FartEscape_TheEggDrop_C", "OnSlottedEvent");

	Params::UFartEscape_TheEggDrop_C_OnSlottedEvent_Params Parms{};
...
// Function FartEscape_TheEggDrop.FartEscape_TheEggDrop_C.OnUnslottedEvent
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
...
void UFartEscape_TheEggDrop_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FartEscape_TheEggDrop_C", "OnUnslottedEvent");

	Params::UFartEscape_TheEggDrop_C_OnUnslottedEvent_Params Parms{};
...
// Function FartEscape_TheEggDrop.FartEscape_TheEggDrop_C.OnUpgradeRolledDataChangedEvent
...
void UFartEscape_TheEggDrop_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FartEscape_TheEggDrop_C", "OnUpgradeRolledDataChangedEvent");

	Params::UFartEscape_TheEggDrop_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
// Function FartEscape_TheEggDrop.FartEscape_TheEggDrop_C.ExecuteUbergraph_FartEscape_TheEggDrop
