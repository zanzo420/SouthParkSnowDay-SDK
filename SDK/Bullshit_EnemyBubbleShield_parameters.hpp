...
struct UBullshit_EnemyBubbleShield_C_OnDebugDisplay_Params
{
public:
...
struct UBullshit_EnemyBubbleShield_C_OnBullshitTick_Params
{
public:
...
struct UBullshit_EnemyBubbleShield_C_PlayerEnterWorldEvent_Event_0_Params
{
public:
...
struct UBullshit_EnemyBubbleShield_C_ExecuteUbergraph_Bullshit_EnemyBubbleShield_Params
{
public:
	...
	class UQtnStatusEffect*                      CallFunc_AddStatusEffect_ServerOnly_ReturnValue;   // 0x20(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
