...
class UWand_ProfligateFlames_C : public UQtnUpgradeArchetype_C
{
public:
	uint8                                        Pad_3201[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x88(0x8)(ZeroConstructor, Transient, DuplicateTransient)

	static class UClass* StaticClass();
	static class UWand_ProfligateFlames_C* GetDefaultObj();
