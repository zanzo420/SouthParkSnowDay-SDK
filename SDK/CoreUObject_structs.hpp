...
public:
	float                                        InVal;                                             // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_64[0xC];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_66[0xF];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_91[0x50];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_95[0x38];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
