...
{
public:
	uint8                                        Pad_3[0x28];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_A[0x40];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	class UObject*                               DefaultObject;                                     // (0x118[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_B[0x110];                                      // Fixing Size Of Struct [ Dumper-7 ]
