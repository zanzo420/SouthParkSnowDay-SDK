...
class ABP_ShizaEmergeLocation_C : public AActor
{
public:
	...
	static class ABP_ShizaEmergeLocation_C* GetDefaultObj();

	void UserConstructionScript();
	void ReceiveBeginPlay();
	void ReceiveEndPlay(enum class EEndPlayReason EndPlayReason);
	void ExecuteUbergraph_BP_ShizaEmergeLocation(int32 EntryPoint, TSoftObjectPtr<class ABP_ShizaEmergeLocation_C> CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue, bool CallFunc_IsPlayingInEditor_ReturnValue, class AQtnGameState* CallFunc_GetQtnGameState_ReturnValue, enum class EEndPlayReason K2Node_Event_EndPlayReason, class AQtnGameStateArchetype_C* K2Node_DynamicCast_AsQtn_Game_State_Archetype, bool K2Node_DynamicCast_bSuccess, class AQtnGameState* CallFunc_GetQtnGameState_ReturnValue_1, class AQtnGameStateArchetype_C* K2Node_DynamicCast_AsQtn_Game_State_Archetype_1, bool K2Node_DynamicCast_bSuccess_1, TSoftObjectPtr<class ABP_ShizaEmergeLocation_C> CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue_1, int32 CallFunc_Array_Add_ReturnValue, bool CallFunc_Array_RemoveItem_ReturnValue);
};
