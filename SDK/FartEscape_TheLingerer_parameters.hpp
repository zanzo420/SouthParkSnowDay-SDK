...
struct UFartEscape_TheLingerer_C_OnSlottedEvent_Params
{
public:
...
struct UFartEscape_TheLingerer_C_OnUnslottedEvent_Params
{
public:
...
struct UFartEscape_TheLingerer_C_OnUpgradeRolledDataChangedEvent_Params
{
public:
...
struct UFartEscape_TheLingerer_C_ExecuteUbergraph_FartEscape_TheLingerer_Params
{
public:
	...
	class UFartEscapeVerb_C*                     K2Node_DynamicCast_AsFart_Escape_Verb;             // 0x148(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFartEscapeVerb_C*                     K2Node_DynamicCast_AsFart_Escape_Verb_1;           // 0x160(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_GetValueOfUpgrade_ReturnValue_1;          // 0x1DC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
