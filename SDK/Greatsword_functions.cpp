...
// BlueprintGeneratedClass Greatsword.Greatsword_C
// (Actor)

class UClass* AGreatsword_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Greatsword_C");

	return Clss;
}


// Greatsword_C Greatsword.Default__Greatsword_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGreatsword_C* AGreatsword_C::GetDefaultObj()
{
	static class AGreatsword_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGreatsword_C*>(AGreatsword_C::StaticClass()->DefaultObject);
...
void AGreatsword_C::AddMeshForRender(class UStaticMesh* In_Mesh, class AActor* In_Owner, class UStaticMeshComponent** Out_Mesh, class UStaticMeshComponent* L_StaticMesh, const struct FTransform& Temp_struct_Variable, class UStaticMeshComponent* CallFunc_AddComponent_ReturnValue, bool CallFunc_SetStaticMesh_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Greatsword_C", "AddMeshForRender");

	Params::AGreatsword_C_AddMeshForRender_Params Parms{};
...
void AGreatsword_C::HandleUnequip_Derived(class AQtnBodyPawn* bodyPawn)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Greatsword_C", "HandleUnequip_Derived");

	Params::AGreatsword_C_HandleUnequip_Derived_Params Parms{};
...
void AGreatsword_C::HandleEquip_Derived(class AQtnBodyPawn* bodyPawn, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Greatsword_C", "HandleEquip_Derived");

	Params::AGreatsword_C_HandleEquip_Derived_Params Parms{};
...
void AGreatsword_C::OnAttachItemData(const struct FQtnItemData& ItemData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Greatsword_C", "OnAttachItemData");

	Params::AGreatsword_C_OnAttachItemData_Params Parms{};
