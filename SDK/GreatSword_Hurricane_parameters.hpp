...
struct UGreatSword_Hurricane_C_OnSlottedEvent_Params
{
public:
...
struct UGreatSword_Hurricane_C_OnUnslottedEvent_Params
{
public:
...
struct UGreatSword_Hurricane_C_OnUpgradeRolledDataChangedEvent_Params
{
public:
...
struct UGreatSword_Hurricane_C_ExecuteUbergraph_GreatSword_Hurricane_Params
{
public:
	...
	class UQtnVerbComponent*                     CallFunc_GetVerbComponent_ReturnValue_1;           // 0x170(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UMeleeVerbGreatWeaponCombo_C*          CallFunc_GetVerb_ReturnValue_1;                    // 0x178(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_7681[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UMeleeVerbGreatWeaponCombo_C*          CallFunc_GetVerb_ReturnValue_2;                    // 0x210(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
