...
class UClass* UStatusEffect_LowBurn_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("StatusEffect_LowBurn_C");

	return Clss;
}


// StatusEffect_LowBurn_C StatusEffect_LowBurn.Default__StatusEffect_LowBurn_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UStatusEffect_LowBurn_C* UStatusEffect_LowBurn_C::GetDefaultObj()
{
	static class UStatusEffect_LowBurn_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UStatusEffect_LowBurn_C*>(UStatusEffect_LowBurn_C::StaticClass()->DefaultObject);
...
void UStatusEffect_LowBurn_C::OnDebugDisplay(class UQtnDebugWrapper* DebugWrapper, const class FString& CallFunc_MakeLiteralString_ReturnValue, const class FString& CallFunc_Conv_FloatToString_ReturnValue, const class FString& CallFunc_Concat_StrStr_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("StatusEffect_LowBurn_C", "OnDebugDisplay");

	Params::UStatusEffect_LowBurn_C_OnDebugDisplay_Params Parms{};
...
void UStatusEffect_LowBurn_C::OnStatusEffectBegin(class AActor* AffectedActor, class AQtnPawn* Instigator)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("StatusEffect_LowBurn_C", "OnStatusEffectBegin");

	Params::UStatusEffect_LowBurn_C_OnStatusEffectBegin_Params Parms{};
...
void UStatusEffect_LowBurn_C::OnStatusEffectTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("StatusEffect_LowBurn_C", "OnStatusEffectTick");

	Params::UStatusEffect_LowBurn_C_OnStatusEffectTick_Params Parms{};
...
void UStatusEffect_LowBurn_C::OnStatusEffectEnd(class AActor* AffectedActor, class AQtnPawn* Instigator, bool IsActorBeingDestroyed)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("StatusEffect_LowBurn_C", "OnStatusEffectEnd");

	Params::UStatusEffect_LowBurn_C_OnStatusEffectEnd_Params Parms{};
