...
class UClass* UHealingTotem_BurningGaze_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HealingTotem_BurningGaze_C");

	return Clss;
}


// HealingTotem_BurningGaze_C HealingTotem_BurningGaze.Default__HealingTotem_BurningGaze_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHealingTotem_BurningGaze_C* UHealingTotem_BurningGaze_C::GetDefaultObj()
{
	static class UHealingTotem_BurningGaze_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHealingTotem_BurningGaze_C*>(UHealingTotem_BurningGaze_C::StaticClass()->DefaultObject);
...
void UHealingTotem_BurningGaze_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("HealingTotem_BurningGaze_C", "OnSlottedEvent");

	Params::UHealingTotem_BurningGaze_C_OnSlottedEvent_Params Parms{};
...
void UHealingTotem_BurningGaze_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("HealingTotem_BurningGaze_C", "OnUnslottedEvent");

	Params::UHealingTotem_BurningGaze_C_OnUnslottedEvent_Params Parms{};
...
void UHealingTotem_BurningGaze_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("HealingTotem_BurningGaze_C", "OnUpgradeRolledDataChangedEvent");

	Params::UHealingTotem_BurningGaze_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
