...
// BlueprintGeneratedClass BullRush_WallSlam.BullRush_WallSlam_C
// (None)

class UClass* UBullRush_WallSlam_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BullRush_WallSlam_C");

	return Clss;
}


// BullRush_WallSlam_C BullRush_WallSlam.Default__BullRush_WallSlam_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBullRush_WallSlam_C* UBullRush_WallSlam_C::GetDefaultObj()
{
	static class UBullRush_WallSlam_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBullRush_WallSlam_C*>(UBullRush_WallSlam_C::StaticClass()->DefaultObject);
...
void UBullRush_WallSlam_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BullRush_WallSlam_C", "OnSlottedEvent");

	Params::UBullRush_WallSlam_C_OnSlottedEvent_Params Parms{};
...
void UBullRush_WallSlam_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BullRush_WallSlam_C", "OnUnslottedEvent");

	Params::UBullRush_WallSlam_C_OnUnslottedEvent_Params Parms{};
...
void UBullRush_WallSlam_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BullRush_WallSlam_C", "OnUpgradeRolledDataChangedEvent");

	Params::UBullRush_WallSlam_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
void UBullRush_WallSlam_C::ExecuteUbergraph_BullRush_WallSlam(int32 EntryPoint, class UQtnUpgradeSlot* K2Node_Event_OwningSlot, const struct FQtnRolledUpgradeData& K2Node_Event_PreviousRolledData, const struct FQtnRolledUpgradeData& K2Node_Event_NewRolledData, float CallFunc_GetValueOfUpgrade_ReturnValue, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue, class UQtnUpgradeSlot* K2Node_Event_TargetSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData_1, bool K2Node_Event_LoadedRunProgress, class UBullRush_Verb_C* K2Node_DynamicCast_AsBull_Rush_Verb, bool K2Node_DynamicCast_bSuccess, float CallFunc_GetValueOfUpgrade_ReturnValue_1, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue_1, class UQtnUpgradeSlot* K2Node_Event_PreviousSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData, class UBullRush_Verb_C* K2Node_DynamicCast_AsBull_Rush_Verb_1, bool K2Node_DynamicCast_bSuccess_1, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue_2, class UBullRush_Verb_C* K2Node_DynamicCast_AsBull_Rush_Verb_2, bool K2Node_DynamicCast_bSuccess_2)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BullRush_WallSlam_C", "ExecuteUbergraph_BullRush_WallSlam");

	Params::UBullRush_WallSlam_C_ExecuteUbergraph_BullRush_WallSlam_Params Parms{};
