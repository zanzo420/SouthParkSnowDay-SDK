...
// BlueprintGeneratedClass Perk_IncreaseHealthEffectiveness.Perk_IncreaseHealthEffectiveness_C
// (None)

class UClass* UPerk_IncreaseHealthEffectiveness_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Perk_IncreaseHealthEffectiveness_C");

	return Clss;
}


// Perk_IncreaseHealthEffectiveness_C Perk_IncreaseHealthEffectiveness.Default__Perk_IncreaseHealthEffectiveness_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPerk_IncreaseHealthEffectiveness_C* UPerk_IncreaseHealthEffectiveness_C::GetDefaultObj()
{
	static class UPerk_IncreaseHealthEffectiveness_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPerk_IncreaseHealthEffectiveness_C*>(UPerk_IncreaseHealthEffectiveness_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Perk_IncreaseHealthEffectiveness.Perk_IncreaseHealthEffectiveness_C.GetPerkValueAtInstanceCount
...
float UPerk_IncreaseHealthEffectiveness_C::GetPerkValueAtInstanceCount(int32 ValueIndex, int32 InstanceCount, float CallFunc_Multiply_IntFloat_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Perk_IncreaseHealthEffectiveness_C", "GetPerkValueAtInstanceCount");

	Params::UPerk_IncreaseHealthEffectiveness_C_GetPerkValueAtInstanceCount_Params Parms{};
...
// Function Perk_IncreaseHealthEffectiveness.Perk_IncreaseHealthEffectiveness_C.OnPerkStackChangeEvent
...
void UPerk_IncreaseHealthEffectiveness_C::OnPerkStackChangeEvent(class AQtnBodyPawn* TargetBodyPawn, int32 PreviousLevel, int32 NewLevel, bool IsServer)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Perk_IncreaseHealthEffectiveness_C", "OnPerkStackChangeEvent");

	Params::UPerk_IncreaseHealthEffectiveness_C_OnPerkStackChangeEvent_Params Parms{};
...
// Function Perk_IncreaseHealthEffectiveness.Perk_IncreaseHealthEffectiveness_C.ExecuteUbergraph_Perk_IncreaseHealthEffectiveness
