...
// 0xD (0x90 - 0x83)
// BlueprintGeneratedClass BubbleShield_Regenerator.BubbleShield_Regenerator_C
class UBubbleShield_Regenerator_C : public UQtnUpgradeArchetype_C
{
public:
	...
	static class UBubbleShield_Regenerator_C* GetDefaultObj();
	...
	void ExecuteUbergraph_BubbleShield_Regenerator(int32 EntryPoint, class UQtnUpgradeSlot* K2Node_Event_OwningSlot, const struct FQtnRolledUpgradeData& K2Node_Event_PreviousRolledData, const struct FQtnRolledUpgradeData& K2Node_Event_NewRolledData, float CallFunc_GetValueOfUpgrade_ReturnValue, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue, class UQtnUpgradeSlot* K2Node_Event_TargetSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData_1, bool K2Node_Event_LoadedRunProgress, class UBubbleShieldVerb_C* K2Node_DynamicCast_AsBubble_Shield_Verb, bool K2Node_DynamicCast_bSuccess, float CallFunc_GetValueOfUpgrade_ReturnValue_1, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue_1, class UQtnUpgradeSlot* K2Node_Event_PreviousSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData, class UBubbleShieldVerb_C* K2Node_DynamicCast_AsBubble_Shield_Verb_1, bool K2Node_DynamicCast_bSuccess_1, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue_2, class UBubbleShieldVerb_C* K2Node_DynamicCast_AsBubble_Shield_Verb_2, bool K2Node_DynamicCast_bSuccess_2);
};
