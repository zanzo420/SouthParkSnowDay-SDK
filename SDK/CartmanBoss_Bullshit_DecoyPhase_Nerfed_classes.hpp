...
class UCartmanBoss_Bullshit_DecoyPhase_Nerfed_C : public UQtnVerb_Archetype_C
{
public:
	...
	static class UCartmanBoss_Bullshit_DecoyPhase_Nerfed_C* GetDefaultObj();
