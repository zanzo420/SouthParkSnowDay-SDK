...
// BlueprintGeneratedClass Upgrade_Tower_Homing.Upgrade_Tower_Homing_C
// (None)

class UClass* UUpgrade_Tower_Homing_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Upgrade_Tower_Homing_C");

	return Clss;
}


// Upgrade_Tower_Homing_C Upgrade_Tower_Homing.Default__Upgrade_Tower_Homing_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUpgrade_Tower_Homing_C* UUpgrade_Tower_Homing_C::GetDefaultObj()
{
	static class UUpgrade_Tower_Homing_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUpgrade_Tower_Homing_C*>(UUpgrade_Tower_Homing_C::StaticClass()->DefaultObject);
...
void UUpgrade_Tower_Homing_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_Homing_C", "OnSlottedEvent");

	Params::UUpgrade_Tower_Homing_C_OnSlottedEvent_Params Parms{};
...
void UUpgrade_Tower_Homing_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_Homing_C", "OnUnslottedEvent");

	Params::UUpgrade_Tower_Homing_C_OnUnslottedEvent_Params Parms{};
...
void UUpgrade_Tower_Homing_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_Homing_C", "OnUpgradeRolledDataChangedEvent");

	Params::UUpgrade_Tower_Homing_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
void UUpgrade_Tower_Homing_C::ExecuteUbergraph_Upgrade_Tower_Homing(int32 EntryPoint, class UQtnUpgradeSlot* K2Node_Event_OwningSlot, const struct FQtnRolledUpgradeData& K2Node_Event_PreviousRolledData, const struct FQtnRolledUpgradeData& K2Node_Event_NewRolledData, float CallFunc_GetValueOfUpgrade_ReturnValue, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue, class UQtnUpgradeSlot* K2Node_Event_TargetSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData_1, bool K2Node_Event_LoadedRunProgress, class URangedTowerVerb_C* K2Node_DynamicCast_AsRanged_Tower_Verb, bool K2Node_DynamicCast_bSuccess, float CallFunc_GetValueOfUpgrade_ReturnValue_1, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue_1, class UQtnUpgradeSlot* K2Node_Event_PreviousSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData, class URangedTowerVerb_C* K2Node_DynamicCast_AsRanged_Tower_Verb_1, bool K2Node_DynamicCast_bSuccess_1, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue_2, class URangedTowerVerb_C* K2Node_DynamicCast_AsRanged_Tower_Verb_2, bool K2Node_DynamicCast_bSuccess_2)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_Homing_C", "ExecuteUbergraph_Upgrade_Tower_Homing");

	Params::UUpgrade_Tower_Homing_C_ExecuteUbergraph_Upgrade_Tower_Homing_Params Parms{};
