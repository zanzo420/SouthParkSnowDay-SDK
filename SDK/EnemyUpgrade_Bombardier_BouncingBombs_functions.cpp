...
// BlueprintGeneratedClass EnemyUpgrade_Bombardier_BouncingBombs.EnemyUpgrade_Bombardier_BouncingBombs_C
// (None)

class UClass* UEnemyUpgrade_Bombardier_BouncingBombs_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("EnemyUpgrade_Bombardier_BouncingBombs_C");

	return Clss;
}


// EnemyUpgrade_Bombardier_BouncingBombs_C EnemyUpgrade_Bombardier_BouncingBombs.Default__EnemyUpgrade_Bombardier_BouncingBombs_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UEnemyUpgrade_Bombardier_BouncingBombs_C* UEnemyUpgrade_Bombardier_BouncingBombs_C::GetDefaultObj()
{
	static class UEnemyUpgrade_Bombardier_BouncingBombs_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UEnemyUpgrade_Bombardier_BouncingBombs_C*>(UEnemyUpgrade_Bombardier_BouncingBombs_C::StaticClass()->DefaultObject);
