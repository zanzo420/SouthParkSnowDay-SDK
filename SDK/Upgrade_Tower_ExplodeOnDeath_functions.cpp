...
// BlueprintGeneratedClass Upgrade_Tower_ExplodeOnDeath.Upgrade_Tower_ExplodeOnDeath_C
// (None)

class UClass* UUpgrade_Tower_ExplodeOnDeath_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Upgrade_Tower_ExplodeOnDeath_C");

	return Clss;
}


// Upgrade_Tower_ExplodeOnDeath_C Upgrade_Tower_ExplodeOnDeath.Default__Upgrade_Tower_ExplodeOnDeath_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUpgrade_Tower_ExplodeOnDeath_C* UUpgrade_Tower_ExplodeOnDeath_C::GetDefaultObj()
{
	static class UUpgrade_Tower_ExplodeOnDeath_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUpgrade_Tower_ExplodeOnDeath_C*>(UUpgrade_Tower_ExplodeOnDeath_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Upgrade_Tower_ExplodeOnDeath.Upgrade_Tower_ExplodeOnDeath_C.OnSlottedEvent
...
void UUpgrade_Tower_ExplodeOnDeath_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_ExplodeOnDeath_C", "OnSlottedEvent");

	Params::UUpgrade_Tower_ExplodeOnDeath_C_OnSlottedEvent_Params Parms{};
...
// Function Upgrade_Tower_ExplodeOnDeath.Upgrade_Tower_ExplodeOnDeath_C.OnUnslottedEvent
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
...
void UUpgrade_Tower_ExplodeOnDeath_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_ExplodeOnDeath_C", "OnUnslottedEvent");

	Params::UUpgrade_Tower_ExplodeOnDeath_C_OnUnslottedEvent_Params Parms{};
...
// Function Upgrade_Tower_ExplodeOnDeath.Upgrade_Tower_ExplodeOnDeath_C.OnUpgradeRolledDataChangedEvent
...
void UUpgrade_Tower_ExplodeOnDeath_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_ExplodeOnDeath_C", "OnUpgradeRolledDataChangedEvent");

	Params::UUpgrade_Tower_ExplodeOnDeath_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
// Function Upgrade_Tower_ExplodeOnDeath.Upgrade_Tower_ExplodeOnDeath_C.ExecuteUbergraph_Upgrade_Tower_ExplodeOnDeath
...
// class URangedTowerVerb_C*          K2Node_DynamicCast_AsRanged_Tower_Verb                           (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class URangedTowerVerb_C*          K2Node_DynamicCast_AsRanged_Tower_Verb_1                         (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class URangedTowerVerb_C*          K2Node_DynamicCast_AsRanged_Tower_Verb_2                         (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_DynamicCast_bSuccess_2                                    (ZeroConstructor, IsPlainOldData, NoDestructor)

void UUpgrade_Tower_ExplodeOnDeath_C::ExecuteUbergraph_Upgrade_Tower_ExplodeOnDeath(int32 EntryPoint, class UQtnUpgradeSlot* K2Node_Event_OwningSlot, const struct FQtnRolledUpgradeData& K2Node_Event_PreviousRolledData, const struct FQtnRolledUpgradeData& K2Node_Event_NewRolledData, class UQtnUpgradeSlot* K2Node_Event_PreviousSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue, float CallFunc_GetValueOfUpgrade_ReturnValue, class URangedTowerVerb_C* K2Node_DynamicCast_AsRanged_Tower_Verb, bool K2Node_DynamicCast_bSuccess, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_GetValueOfUpgrade_ReturnValue_1, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue_1, class UQtnUpgradeSlot* K2Node_Event_TargetSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData_1, bool K2Node_Event_LoadedRunProgress, class URangedTowerVerb_C* K2Node_DynamicCast_AsRanged_Tower_Verb_1, bool K2Node_DynamicCast_bSuccess_1, float CallFunc_GetValueOfUpgrade_ReturnValue_2, float CallFunc_GetValueOfUpgrade_ReturnValue_3, float CallFunc_Multiply_FloatFloat_ReturnValue_1, class UQtnVerb* CallFunc_GetOwningVerb_ReturnValue_2, class URangedTowerVerb_C* K2Node_DynamicCast_AsRanged_Tower_Verb_2, bool K2Node_DynamicCast_bSuccess_2)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_ExplodeOnDeath_C", "ExecuteUbergraph_Upgrade_Tower_ExplodeOnDeath");

	Params::UUpgrade_Tower_ExplodeOnDeath_C_ExecuteUbergraph_Upgrade_Tower_ExplodeOnDeath_Params Parms{};
	...
	Parms.K2Node_DynamicCast_AsRanged_Tower_Verb = K2Node_DynamicCast_AsRanged_Tower_Verb;
	...
	Parms.K2Node_DynamicCast_AsRanged_Tower_Verb_1 = K2Node_DynamicCast_AsRanged_Tower_Verb_1;
	...
	Parms.K2Node_DynamicCast_AsRanged_Tower_Verb_2 = K2Node_DynamicCast_AsRanged_Tower_Verb_2;
