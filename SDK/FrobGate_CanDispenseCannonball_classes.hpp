...
// 0x0 (0x50 - 0x50)
// BlueprintGeneratedClass FrobGate_CanDispenseCannonball.FrobGate_CanDispenseCannonball_C
class UFrobGate_CanDispenseCannonball_C : public UQtnFrobGate
{
public:

	static class UClass* StaticClass();
	static class UFrobGate_CanDispenseCannonball_C* GetDefaultObj();
