...
// BlueprintGeneratedClass Outcome_PlayerMeleeUses.Outcome_PlayerMeleeUses_C
// (None)

class UClass* UOutcome_PlayerMeleeUses_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Outcome_PlayerMeleeUses_C");

	return Clss;
}


// Outcome_PlayerMeleeUses_C Outcome_PlayerMeleeUses.Default__Outcome_PlayerMeleeUses_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UOutcome_PlayerMeleeUses_C* UOutcome_PlayerMeleeUses_C::GetDefaultObj()
{
	static class UOutcome_PlayerMeleeUses_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UOutcome_PlayerMeleeUses_C*>(UOutcome_PlayerMeleeUses_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Outcome_PlayerMeleeUses.Outcome_PlayerMeleeUses_C.K2_CalculateOutcome
