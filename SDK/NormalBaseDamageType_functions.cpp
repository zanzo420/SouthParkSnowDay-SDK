...
class UClass* UNormalBaseDamageType_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("NormalBaseDamageType_C");

	return Clss;
}


// NormalBaseDamageType_C NormalBaseDamageType.Default__NormalBaseDamageType_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UNormalBaseDamageType_C* UNormalBaseDamageType_C::GetDefaultObj()
{
	static class UNormalBaseDamageType_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UNormalBaseDamageType_C*>(UNormalBaseDamageType_C::StaticClass()->DefaultObject);

	return Default;
}


// Function NormalBaseDamageType.NormalBaseDamageType_C.Test Whether Normal Status Effect Thresholding Should Apply
...
// Function NormalBaseDamageType.NormalBaseDamageType_C.Apply Threshold Attribute For Status Effects
