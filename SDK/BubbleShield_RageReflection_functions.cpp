...
// BlueprintGeneratedClass BubbleShield_RageReflection.BubbleShield_RageReflection_C
// (None)

class UClass* UBubbleShield_RageReflection_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BubbleShield_RageReflection_C");

	return Clss;
}


// BubbleShield_RageReflection_C BubbleShield_RageReflection.Default__BubbleShield_RageReflection_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBubbleShield_RageReflection_C* UBubbleShield_RageReflection_C::GetDefaultObj()
{
	static class UBubbleShield_RageReflection_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBubbleShield_RageReflection_C*>(UBubbleShield_RageReflection_C::StaticClass()->DefaultObject);
...
void UBubbleShield_RageReflection_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BubbleShield_RageReflection_C", "OnSlottedEvent");

	Params::UBubbleShield_RageReflection_C_OnSlottedEvent_Params Parms{};
...
void UBubbleShield_RageReflection_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BubbleShield_RageReflection_C", "OnUnslottedEvent");

	Params::UBubbleShield_RageReflection_C_OnUnslottedEvent_Params Parms{};
...
void UBubbleShield_RageReflection_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BubbleShield_RageReflection_C", "OnUpgradeRolledDataChangedEvent");

	Params::UBubbleShield_RageReflection_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
