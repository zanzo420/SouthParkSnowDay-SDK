...
class UClass* UBlankHUD_Screen_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BlankHUD_Screen_C");

	return Clss;
}


// BlankHUD_Screen_C BlankHUD_Screen.Default__BlankHUD_Screen_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBlankHUD_Screen_C* UBlankHUD_Screen_C::GetDefaultObj()
{
	static class UBlankHUD_Screen_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBlankHUD_Screen_C*>(UBlankHUD_Screen_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BlankHUD_Screen.BlankHUD_Screen_C.OnScreenStopped
// (Event, Protected, BlueprintEvent)
// Parameters:

void UBlankHUD_Screen_C::OnScreenStopped()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BlankHUD_Screen_C", "OnScreenStopped");
...
// Function BlankHUD_Screen.BlankHUD_Screen_C.OnScreenStarted
// (Event, Protected, BlueprintEvent)
// Parameters:

void UBlankHUD_Screen_C::OnScreenStarted()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BlankHUD_Screen_C", "OnScreenStarted");
...
// Function BlankHUD_Screen.BlankHUD_Screen_C.ExecuteUbergraph_BlankHUD_Screen
