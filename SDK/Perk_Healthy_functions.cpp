...
// BlueprintGeneratedClass Perk_Healthy.Perk_Healthy_C
// (None)

class UClass* UPerk_Healthy_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Perk_Healthy_C");

	return Clss;
}


// Perk_Healthy_C Perk_Healthy.Default__Perk_Healthy_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPerk_Healthy_C* UPerk_Healthy_C::GetDefaultObj()
{
	static class UPerk_Healthy_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPerk_Healthy_C*>(UPerk_Healthy_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Perk_Healthy.Perk_Healthy_C.GetPerkValueAtInstanceCount
...
float UPerk_Healthy_C::GetPerkValueAtInstanceCount(int32 ValueIndex, int32 InstanceCount, float CallFunc_Multiply_IntFloat_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Perk_Healthy_C", "GetPerkValueAtInstanceCount");

	Params::UPerk_Healthy_C_GetPerkValueAtInstanceCount_Params Parms{};
...
// Function Perk_Healthy.Perk_Healthy_C.OnPerkStackChangeEvent
...
void UPerk_Healthy_C::OnPerkStackChangeEvent(class AQtnBodyPawn* TargetBodyPawn, int32 PreviousLevel, int32 NewLevel, bool IsServer)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Perk_Healthy_C", "OnPerkStackChangeEvent");

	Params::UPerk_Healthy_C_OnPerkStackChangeEvent_Params Parms{};
...
// Function Perk_Healthy.Perk_Healthy_C.ExecuteUbergraph_Perk_Healthy
