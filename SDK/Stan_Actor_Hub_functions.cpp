...
class UClass* AStan_Actor_Hub_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Stan_Actor_Hub_C");

	return Clss;
}


// Stan_Actor_Hub_C Stan_Actor_Hub.Default__Stan_Actor_Hub_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AStan_Actor_Hub_C* AStan_Actor_Hub_C::GetDefaultObj()
{
	static class AStan_Actor_Hub_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AStan_Actor_Hub_C*>(AStan_Actor_Hub_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Stan_Actor_Hub.Stan_Actor_Hub_C.GetDayForOnTalkTo
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// int32                              Day                                                              (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AStan_Actor_Hub_C::GetDayForOnTalkTo(int32* Day)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Stan_Actor_Hub_C", "GetDayForOnTalkTo");

	Params::AStan_Actor_Hub_C_GetDayForOnTalkTo_Params Parms{};
...
// Function Stan_Actor_Hub.Stan_Actor_Hub_C.OnRep_InHideout
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void AStan_Actor_Hub_C::OnRep_InHideout()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Stan_Actor_Hub_C", "OnRep_InHideout");
...
// Function Stan_Actor_Hub.Stan_Actor_Hub_C.CheckDayStatus
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void AStan_Actor_Hub_C::CheckDayStatus()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Stan_Actor_Hub_C", "CheckDayStatus");
...
// Function Stan_Actor_Hub.Stan_Actor_Hub_C.BndEvt__Stan_Actor_Hub_QtnFrobbable_K2Node_ComponentBoundEvent_0_QtnOnFrobEvent__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void AStan_Actor_Hub_C::BndEvt__Stan_Actor_Hub_QtnFrobbable_K2Node_ComponentBoundEvent_0_QtnOnFrobEvent__DelegateSignature(class UQtnFrobbableComponent* ThisFrobbable, class AQtnBodyPawn* FrobbingPawn, bool IsServer)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Stan_Actor_Hub_C", "BndEvt__Stan_Actor_Hub_QtnFrobbable_K2Node_ComponentBoundEvent_0_QtnOnFrobEvent__DelegateSignature");

	Params::AStan_Actor_Hub_C_BndEvt__Stan_Actor_Hub_QtnFrobbable_K2Node_ComponentBoundEvent_0_QtnOnFrobEvent__DelegateSignature_Params Parms{};
...
// Function Stan_Actor_Hub.Stan_Actor_Hub_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void AStan_Actor_Hub_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Stan_Actor_Hub_C", "ReceiveBeginPlay");
...
// Function Stan_Actor_Hub.Stan_Actor_Hub_C.ExecuteUbergraph_Stan_Actor_Hub
