...
// BlueprintGeneratedClass Brainwash_VampiricCheesing.Brainwash_VampiricCheesing_C
// (None)

class UClass* UBrainwash_VampiricCheesing_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Brainwash_VampiricCheesing_C");

	return Clss;
}


// Brainwash_VampiricCheesing_C Brainwash_VampiricCheesing.Default__Brainwash_VampiricCheesing_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBrainwash_VampiricCheesing_C* UBrainwash_VampiricCheesing_C::GetDefaultObj()
{
	static class UBrainwash_VampiricCheesing_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBrainwash_VampiricCheesing_C*>(UBrainwash_VampiricCheesing_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Brainwash_VampiricCheesing.Brainwash_VampiricCheesing_C.OnSlottedEvent
...
void UBrainwash_VampiricCheesing_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Brainwash_VampiricCheesing_C", "OnSlottedEvent");

	Params::UBrainwash_VampiricCheesing_C_OnSlottedEvent_Params Parms{};
...
// Function Brainwash_VampiricCheesing.Brainwash_VampiricCheesing_C.OnUnslottedEvent
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
...
void UBrainwash_VampiricCheesing_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Brainwash_VampiricCheesing_C", "OnUnslottedEvent");

	Params::UBrainwash_VampiricCheesing_C_OnUnslottedEvent_Params Parms{};
...
// Function Brainwash_VampiricCheesing.Brainwash_VampiricCheesing_C.OnUpgradeRolledDataChangedEvent
...
void UBrainwash_VampiricCheesing_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Brainwash_VampiricCheesing_C", "OnUpgradeRolledDataChangedEvent");

	Params::UBrainwash_VampiricCheesing_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
// Function Brainwash_VampiricCheesing.Brainwash_VampiricCheesing_C.ExecuteUbergraph_Brainwash_VampiricCheesing
