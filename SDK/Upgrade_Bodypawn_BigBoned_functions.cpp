...
class UClass* UUpgrade_Bodypawn_BigBoned_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Upgrade_Bodypawn_BigBoned_C");

	return Clss;
}


// Upgrade_Bodypawn_BigBoned_C Upgrade_Bodypawn_BigBoned.Default__Upgrade_Bodypawn_BigBoned_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUpgrade_Bodypawn_BigBoned_C* UUpgrade_Bodypawn_BigBoned_C::GetDefaultObj()
{
	static class UUpgrade_Bodypawn_BigBoned_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUpgrade_Bodypawn_BigBoned_C*>(UUpgrade_Bodypawn_BigBoned_C::StaticClass()->DefaultObject);
...
void UUpgrade_Bodypawn_BigBoned_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Bodypawn_BigBoned_C", "OnSlottedEvent");

	Params::UUpgrade_Bodypawn_BigBoned_C_OnSlottedEvent_Params Parms{};
...
void UUpgrade_Bodypawn_BigBoned_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Bodypawn_BigBoned_C", "OnUnslottedEvent");

	Params::UUpgrade_Bodypawn_BigBoned_C_OnUnslottedEvent_Params Parms{};
...
void UUpgrade_Bodypawn_BigBoned_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Bodypawn_BigBoned_C", "OnUpgradeRolledDataChangedEvent");

	Params::UUpgrade_Bodypawn_BigBoned_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
