...
class UQtnGoal_FTUX_RarityAndReshuffle_C : public UGoalBase_C
{
public:
	...
	TArray<struct FQtnStruct_VOLine>             VO_Beckon;                                         // 0x350(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)
	int32                                        GrantedTPTotal;                                    // 0x360(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UQtnGoal_FTUX_RarityAndReshuffle_C* GetDefaultObj();

	void VO_PlayBeckonReminder(enum class EQtnGoalStatus CallFunc_GetGoalStatus_ReturnValue, const struct FQtnStruct_VOLine& CallFunc_Array_Get_Item, bool K2Node_SwitchEnum_CmpSuccess);
