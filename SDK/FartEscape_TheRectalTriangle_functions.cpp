...
class UClass* UFartEscape_TheRectalTriangle_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FartEscape_TheRectalTriangle_C");

	return Clss;
}


// FartEscape_TheRectalTriangle_C FartEscape_TheRectalTriangle.Default__FartEscape_TheRectalTriangle_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFartEscape_TheRectalTriangle_C* UFartEscape_TheRectalTriangle_C::GetDefaultObj()
{
	static class UFartEscape_TheRectalTriangle_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFartEscape_TheRectalTriangle_C*>(UFartEscape_TheRectalTriangle_C::StaticClass()->DefaultObject);
...
void UFartEscape_TheRectalTriangle_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FartEscape_TheRectalTriangle_C", "OnSlottedEvent");

	Params::UFartEscape_TheRectalTriangle_C_OnSlottedEvent_Params Parms{};
...
void UFartEscape_TheRectalTriangle_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FartEscape_TheRectalTriangle_C", "OnUnslottedEvent");

	Params::UFartEscape_TheRectalTriangle_C_OnUnslottedEvent_Params Parms{};
...
void UFartEscape_TheRectalTriangle_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FartEscape_TheRectalTriangle_C", "OnUpgradeRolledDataChangedEvent");

	Params::UFartEscape_TheRectalTriangle_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
