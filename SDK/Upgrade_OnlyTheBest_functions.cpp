...
// BlueprintGeneratedClass Upgrade_OnlyTheBest.Upgrade_OnlyTheBest_C
// (None)

class UClass* UUpgrade_OnlyTheBest_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Upgrade_OnlyTheBest_C");

	return Clss;
}


// Upgrade_OnlyTheBest_C Upgrade_OnlyTheBest.Default__Upgrade_OnlyTheBest_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUpgrade_OnlyTheBest_C* UUpgrade_OnlyTheBest_C::GetDefaultObj()
{
	static class UUpgrade_OnlyTheBest_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUpgrade_OnlyTheBest_C*>(UUpgrade_OnlyTheBest_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Upgrade_OnlyTheBest.Upgrade_OnlyTheBest_C.OnSlottedEvent
...
void UUpgrade_OnlyTheBest_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_OnlyTheBest_C", "OnSlottedEvent");

	Params::UUpgrade_OnlyTheBest_C_OnSlottedEvent_Params Parms{};
...
// Function Upgrade_OnlyTheBest.Upgrade_OnlyTheBest_C.OnUnslottedEvent
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
...
void UUpgrade_OnlyTheBest_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_OnlyTheBest_C", "OnUnslottedEvent");

	Params::UUpgrade_OnlyTheBest_C_OnUnslottedEvent_Params Parms{};
...
// Function Upgrade_OnlyTheBest.Upgrade_OnlyTheBest_C.OnUpgradeRolledDataChangedEvent
...
void UUpgrade_OnlyTheBest_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_OnlyTheBest_C", "OnUpgradeRolledDataChangedEvent");

	Params::UUpgrade_OnlyTheBest_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
// Function Upgrade_OnlyTheBest.Upgrade_OnlyTheBest_C.ExecuteUbergraph_Upgrade_OnlyTheBest
...
void UUpgrade_OnlyTheBest_C::ExecuteUbergraph_Upgrade_OnlyTheBest(int32 EntryPoint, class UQtnUpgradeSlot* K2Node_Event_TargetSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData_1, bool K2Node_Event_LoadedRunProgress, class UQtnUpgradeSlot* K2Node_Event_PreviousSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData, float CallFunc_GetValueOfUpgrade_ReturnValue, class AQtnBodyPawn* CallFunc_GetOwningBodyPawn_ReturnValue, float CallFunc_GetValueOfUpgrade_ReturnValue_1, bool CallFunc_HasAuthority_ReturnValue, class UQtnAttributeComponent* CallFunc_GetComponentByClass_ReturnValue, TScriptInterface<class IQtnAttributeContainerInterface> K2Node_DynamicCast_AsQtn_Attribute_Container_Interface, bool K2Node_DynamicCast_bSuccess, class AQtnBodyPawn* CallFunc_GetOwningBodyPawn_ReturnValue_1, bool CallFunc_HasAuthority_ReturnValue_1, class UQtnAttributeComponent* CallFunc_GetComponentByClass_ReturnValue_1, TScriptInterface<class IQtnAttributeContainerInterface> K2Node_DynamicCast_AsQtn_Attribute_Container_Interface_1, bool K2Node_DynamicCast_bSuccess_1, class UQtnUpgradeSlot* K2Node_Event_OwningSlot, const struct FQtnRolledUpgradeData& K2Node_Event_PreviousRolledData, const struct FQtnRolledUpgradeData& K2Node_Event_NewRolledData, float CallFunc_GetValueOfUpgradeWithSettings_ReturnValue, class AQtnBodyPawn* CallFunc_GetOwningBodyPawn_ReturnValue_2, class UQtnAttributeComponent* CallFunc_GetComponentByClass_ReturnValue_2, float CallFunc_GetValueOfUpgradeWithSettings_ReturnValue_1, TScriptInterface<class IQtnAttributeContainerInterface> K2Node_DynamicCast_AsQtn_Attribute_Container_Interface_2, bool K2Node_DynamicCast_bSuccess_2, TScriptInterface<class IQtnAttributeContainerInterface> K2Node_DynamicCast_AsQtn_Attribute_Container_Interface_3, bool K2Node_DynamicCast_bSuccess_3, bool CallFunc_HasAuthority_ReturnValue_2)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_OnlyTheBest_C", "ExecuteUbergraph_Upgrade_OnlyTheBest");

	Params::UUpgrade_OnlyTheBest_C_ExecuteUbergraph_Upgrade_OnlyTheBest_Params Parms{};
