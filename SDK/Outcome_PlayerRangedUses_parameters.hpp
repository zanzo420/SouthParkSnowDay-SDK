...
struct UOutcome_PlayerRangedUses_C_K2_CalculateOutcome_Params
{
public:
	...
	bool                                         CallFunc_StaticGetEventContextBool_ReturnValue;    // 0xC0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
