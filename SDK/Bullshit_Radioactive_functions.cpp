...
// BlueprintGeneratedClass Bullshit_Radioactive.Bullshit_Radioactive_C
// (None)

class UClass* UBullshit_Radioactive_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Bullshit_Radioactive_C");

	return Clss;
}


// Bullshit_Radioactive_C Bullshit_Radioactive.Default__Bullshit_Radioactive_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBullshit_Radioactive_C* UBullshit_Radioactive_C::GetDefaultObj()
{
	static class UBullshit_Radioactive_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBullshit_Radioactive_C*>(UBullshit_Radioactive_C::StaticClass()->DefaultObject);
...
void UBullshit_Radioactive_C::OnDebugDisplay(class UQtnDebugWrapper* DebugWrapper, const class FString& CallFunc_GetClassDisplayName_ReturnValue, const class FString& CallFunc_Concat_StrStr_ReturnValue, const class FString& CallFunc_Concat_StrStr_ReturnValue_1, const class FString& CallFunc_GetClassDisplayName_ReturnValue_1, const class FString& CallFunc_Concat_StrStr_ReturnValue_2, const class FString& CallFunc_Concat_StrStr_ReturnValue_3)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Bullshit_Radioactive_C", "OnDebugDisplay");

	Params::UBullshit_Radioactive_C_OnDebugDisplay_Params Parms{};
...
// Function Bullshit_Radioactive.Bullshit_Radioactive_C.getTargets
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UBullshit_Radioactive_C::GetTargets()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Bullshit_Radioactive_C", "getTargets");
...
// Function Bullshit_Radioactive.Bullshit_Radioactive_C.OnBullshitStart
// (Event, Protected, BlueprintEvent)
// Parameters:

void UBullshit_Radioactive_C::OnBullshitStart()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Bullshit_Radioactive_C", "OnBullshitStart");
...
// Function Bullshit_Radioactive.Bullshit_Radioactive_C.OnBullshitStop
// (Event, Protected, BlueprintEvent)
// Parameters:

void UBullshit_Radioactive_C::OnBullshitStop()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Bullshit_Radioactive_C", "OnBullshitStop");
...
void UBullshit_Radioactive_C::PlayerEnterWorldEvent_Event_0(class AQtnPlayerPawn* PlayerPawnSoul, class AQtnBodyPawn* OccupiedBodyPawn, bool IsLocalPlayer)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Bullshit_Radioactive_C", "PlayerEnterWorldEvent_Event_0");

	Params::UBullshit_Radioactive_C_PlayerEnterWorldEvent_Event_0_Params Parms{};
...
void UBullshit_Radioactive_C::OnBullshitTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Bullshit_Radioactive_C", "OnBullshitTick");

	Params::UBullshit_Radioactive_C_OnBullshitTick_Params Parms{};
