...
class UClass* UGravityBomb_AbsoluteZero_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GravityBomb_AbsoluteZero_C");

	return Clss;
}


// GravityBomb_AbsoluteZero_C GravityBomb_AbsoluteZero.Default__GravityBomb_AbsoluteZero_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGravityBomb_AbsoluteZero_C* UGravityBomb_AbsoluteZero_C::GetDefaultObj()
{
	static class UGravityBomb_AbsoluteZero_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGravityBomb_AbsoluteZero_C*>(UGravityBomb_AbsoluteZero_C::StaticClass()->DefaultObject);

	return Default;
}


// Function GravityBomb_AbsoluteZero.GravityBomb_AbsoluteZero_C.OnSlottedEvent
...
void UGravityBomb_AbsoluteZero_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GravityBomb_AbsoluteZero_C", "OnSlottedEvent");

	Params::UGravityBomb_AbsoluteZero_C_OnSlottedEvent_Params Parms{};
...
// Function GravityBomb_AbsoluteZero.GravityBomb_AbsoluteZero_C.OnUnslottedEvent
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
...
void UGravityBomb_AbsoluteZero_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GravityBomb_AbsoluteZero_C", "OnUnslottedEvent");

	Params::UGravityBomb_AbsoluteZero_C_OnUnslottedEvent_Params Parms{};
...
// Function GravityBomb_AbsoluteZero.GravityBomb_AbsoluteZero_C.OnUpgradeRolledDataChangedEvent
...
void UGravityBomb_AbsoluteZero_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GravityBomb_AbsoluteZero_C", "OnUpgradeRolledDataChangedEvent");

	Params::UGravityBomb_AbsoluteZero_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
// Function GravityBomb_AbsoluteZero.GravityBomb_AbsoluteZero_C.ExecuteUbergraph_GravityBomb_AbsoluteZero
