...
// 0x28 (0x28 - 0x0)
// Function FrobGate_DumpGenerator.FrobGate_DumpGenerator_C.GetRejectionMessage
struct UFrobGate_DumpGenerator_C_GetRejectionMessage_Params
{
public:
...
// 0x2B (0x2B - 0x0)
// Function FrobGate_DumpGenerator.FrobGate_DumpGenerator_C.IsFrobAllowed
struct UFrobGate_DumpGenerator_C_IsFrobAllowed_Params
{
public:
	class AQtnBodyPawn*                          bodyPawn;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UQtnFrobbableComponent*                FrobbableComponent;                                // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ADumpGenerator_BP_C*                   K2Node_DynamicCast_AsDump_Generator_BP;            // 0x20(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
