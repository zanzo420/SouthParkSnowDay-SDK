...
// BlueprintGeneratedClass CheatHailStorm.CheatHailStorm_C
// (None)

class UClass* UCheatHailStorm_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CheatHailStorm_C");

	return Clss;
}


// CheatHailStorm_C CheatHailStorm.Default__CheatHailStorm_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCheatHailStorm_C* UCheatHailStorm_C::GetDefaultObj()
{
	static class UCheatHailStorm_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCheatHailStorm_C*>(UCheatHailStorm_C::StaticClass()->DefaultObject);

	return Default;
}


// Function CheatHailStorm.CheatHailStorm_C.OnStatusEffectBegin
...
void UCheatHailStorm_C::OnStatusEffectBegin(class AActor* AffectedActor, class AQtnPawn* Instigator)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("CheatHailStorm_C", "OnStatusEffectBegin");

	Params::UCheatHailStorm_C_OnStatusEffectBegin_Params Parms{};
...
// Function CheatHailStorm.CheatHailStorm_C.OnStatusEffectEnd
// (Event, Protected, BlueprintEvent)
// Parameters:
// class AActor*                      AffectedActor                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AQtnPawn*                    Instigator                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UCheatHailStorm_C::OnStatusEffectEnd(class AActor* AffectedActor, class AQtnPawn* Instigator, bool IsActorBeingDestroyed)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("CheatHailStorm_C", "OnStatusEffectEnd");

	Params::UCheatHailStorm_C_OnStatusEffectEnd_Params Parms{};
...
// Function CheatHailStorm.CheatHailStorm_C.ExecuteUbergraph_CheatHailStorm
...
void UCheatHailStorm_C::ExecuteUbergraph_CheatHailStorm(int32 EntryPoint, bool CallFunc_IsServer_ReturnValue, class AQtnGameState* CallFunc_GetQtnGameState_ReturnValue, class AQtnGameStateArchetype_C* K2Node_DynamicCast_AsQtn_Game_State_Archetype, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsServer_ReturnValue_1, class AQtnGameState* CallFunc_GetQtnGameState_ReturnValue_1, class AActor* K2Node_Event_affectedActor, class AQtnPawn* K2Node_Event_instigator, bool K2Node_Event_isActorBeingDestroyed, class AQtnGameStateArchetype_C* K2Node_DynamicCast_AsQtn_Game_State_Archetype_1, bool K2Node_DynamicCast_bSuccess_1, class AQtnBodyPawn* K2Node_DynamicCast_AsQtn_Body_Pawn, bool K2Node_DynamicCast_bSuccess_2, class AActor* K2Node_Event_affectedActor_1, class AQtnPawn* K2Node_Event_instigator_1, class AQtnBodyPawn* K2Node_DynamicCast_AsQtn_Body_Pawn_1, bool K2Node_DynamicCast_bSuccess_3, class UFTUXDataBag_C* CallFunc_GetLocalProgressDataBag_ReturnValue, const struct FQtnReplicatedSaveData& CallFunc_GetReplicatedEnemyBSSaveData_ServerOnly_combinedReplicatedSaveData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("CheatHailStorm_C", "ExecuteUbergraph_CheatHailStorm");

	Params::UCheatHailStorm_C_ExecuteUbergraph_CheatHailStorm_Params Parms{};
