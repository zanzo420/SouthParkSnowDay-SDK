...
class UClass* UBrainwash_Brainsplosion_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Brainwash_Brainsplosion_C");

	return Clss;
}


// Brainwash_Brainsplosion_C Brainwash_Brainsplosion.Default__Brainwash_Brainsplosion_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBrainwash_Brainsplosion_C* UBrainwash_Brainsplosion_C::GetDefaultObj()
{
	static class UBrainwash_Brainsplosion_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBrainwash_Brainsplosion_C*>(UBrainwash_Brainsplosion_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Brainwash_Brainsplosion.Brainwash_Brainsplosion_C.OnSlottedEvent
...
void UBrainwash_Brainsplosion_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Brainwash_Brainsplosion_C", "OnSlottedEvent");

	Params::UBrainwash_Brainsplosion_C_OnSlottedEvent_Params Parms{};
...
// Function Brainwash_Brainsplosion.Brainwash_Brainsplosion_C.OnUnslottedEvent
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
...
void UBrainwash_Brainsplosion_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Brainwash_Brainsplosion_C", "OnUnslottedEvent");

	Params::UBrainwash_Brainsplosion_C_OnUnslottedEvent_Params Parms{};
...
// Function Brainwash_Brainsplosion.Brainwash_Brainsplosion_C.OnUpgradeRolledDataChangedEvent
...
void UBrainwash_Brainsplosion_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Brainwash_Brainsplosion_C", "OnUpgradeRolledDataChangedEvent");

	Params::UBrainwash_Brainsplosion_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
// Function Brainwash_Brainsplosion.Brainwash_Brainsplosion_C.ExecuteUbergraph_Brainwash_Brainsplosion
