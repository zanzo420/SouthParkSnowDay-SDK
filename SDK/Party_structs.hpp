...
{
public:
	uint8                                        Pad_6AC[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_6B0[0x30];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                PlatformSessionId;                                 // 0x100(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_6B1[0x30];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6B2[0x37];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_6B6[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_6BA[0x35];                                     // Fixing Size After Last Property  [ Dumper-7 ]
