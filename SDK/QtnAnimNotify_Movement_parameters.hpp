...
struct UQtnAnimNotify_Movement_C_Received_Notify_Params
{
public:
	...
	class UCharacterMovementComponent*           CallFunc_GetComponentByClass_ReturnValue;          // 0x20(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
