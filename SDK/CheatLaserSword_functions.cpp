...
class UClass* UCheatLaserSword_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CheatLaserSword_C");

	return Clss;
}


// CheatLaserSword_C CheatLaserSword.Default__CheatLaserSword_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCheatLaserSword_C* UCheatLaserSword_C::GetDefaultObj()
{
	static class UCheatLaserSword_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCheatLaserSword_C*>(UCheatLaserSword_C::StaticClass()->DefaultObject);

	return Default;
}


// Function CheatLaserSword.CheatLaserSword_C.OnStatusEffectBegin
...
void UCheatLaserSword_C::OnStatusEffectBegin(class AActor* AffectedActor, class AQtnPawn* Instigator)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("CheatLaserSword_C", "OnStatusEffectBegin");

	Params::UCheatLaserSword_C_OnStatusEffectBegin_Params Parms{};
...
// Function CheatLaserSword.CheatLaserSword_C.OnStatusEffectEnd
// (Event, Protected, BlueprintEvent)
// Parameters:
// class AActor*                      AffectedActor                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AQtnPawn*                    Instigator                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UCheatLaserSword_C::OnStatusEffectEnd(class AActor* AffectedActor, class AQtnPawn* Instigator, bool IsActorBeingDestroyed)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("CheatLaserSword_C", "OnStatusEffectEnd");

	Params::UCheatLaserSword_C_OnStatusEffectEnd_Params Parms{};
...
// Function CheatLaserSword.CheatLaserSword_C.ExecuteUbergraph_CheatLaserSword
