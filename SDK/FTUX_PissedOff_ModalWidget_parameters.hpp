...
struct UFTUX_PissedOff_ModalWidget_C_SetupImage_Params
{
public:
	...
	class UFTUX_PissedOff_Image_C*               CallFunc_Create_ReturnValue;                       // 0x8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x1F0 (0x1F0 - 0x0)
// Function FTUX_PissedOff_ModalWidget.FTUX_PissedOff_ModalWidget_C.OnKeyDown
struct UFTUX_PissedOff_ModalWidget_C_OnKeyDown_Params
{
public:
...
struct UFTUX_PissedOff_ModalWidget_C_OnUIScreenActionPressed_Params
{
public:
...
struct UFTUX_PissedOff_ModalWidget_C_OnUIBodyActionPressed_Params
{
public:
...
struct UFTUX_PissedOff_ModalWidget_C_OnQtnWidgetTicked_Params
{
public:
...
struct UFTUX_PissedOff_ModalWidget_C_OnInputChange_Params
{
public:
...
struct UFTUX_PissedOff_ModalWidget_C_OnUIScroll_Params
{
public:
...
struct UFTUX_PissedOff_ModalWidget_C_OnQtnWidgetResumed_Params
{
public:
...
struct UFTUX_PissedOff_ModalWidget_C_ExecuteUbergraph_FTUX_PissedOff_ModalWidget_Params
{
public:
	...
	uint8                                        Pad_753B[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
