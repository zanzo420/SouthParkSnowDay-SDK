...
// Function ExplosionDamageType.ExplosionDamageType_C.ApplyIncomingDamage
...
void UExplosionDamageType_C::ApplyIncomingDamage(class AActor* ActorToDamage, struct FQtnDamageInfo& IncomingDamageInfo, struct FQtnDamageInfo* OutgoingDamageInfo, struct FQtnHitReactionInfo* SuggestedHitReact, bool CallFunc_Test_Whether_Normal_Status_Effect_Thresholding_Should_Apply_Thresholding_Should_Apply, const struct FQtnHitReactionInfo& CallFunc_GetDefaultHitReaction_suggestedHitReact)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("ExplosionDamageType_C", "ApplyIncomingDamage");

	Params::UExplosionDamageType_C_ApplyIncomingDamage_Params Parms{};
