...
class UClass* UDroneBomb_BugZapper_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("DroneBomb_BugZapper_C");

	return Clss;
}


// DroneBomb_BugZapper_C DroneBomb_BugZapper.Default__DroneBomb_BugZapper_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UDroneBomb_BugZapper_C* UDroneBomb_BugZapper_C::GetDefaultObj()
{
	static class UDroneBomb_BugZapper_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UDroneBomb_BugZapper_C*>(UDroneBomb_BugZapper_C::StaticClass()->DefaultObject);
...
void UDroneBomb_BugZapper_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("DroneBomb_BugZapper_C", "OnSlottedEvent");

	Params::UDroneBomb_BugZapper_C_OnSlottedEvent_Params Parms{};
...
void UDroneBomb_BugZapper_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("DroneBomb_BugZapper_C", "OnUnslottedEvent");

	Params::UDroneBomb_BugZapper_C_OnUnslottedEvent_Params Parms{};
...
void UDroneBomb_BugZapper_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("DroneBomb_BugZapper_C", "OnUpgradeRolledDataChangedEvent");

	Params::UDroneBomb_BugZapper_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
