...
public:
	...
	uint8                                        Pad_F94[0x9C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_11A7[0x390];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_11AB[0x148];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_11AD[0x1E4];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_11F9[0xA4];                                    // Fixing Size Of Struct [ Dumper-7 ]
