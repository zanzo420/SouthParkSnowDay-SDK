...
struct IInterface_QtnGoal_SP_Day1_AmbushParent_C_DoGetLateJoinTeleportLoc_Params
{
public:
...
struct IInterface_QtnGoal_SP_Day1_AmbushParent_C_DoGetExitGate_Params
{
public:
...
struct IInterface_QtnGoal_SP_Day1_AmbushParent_C_DoGetEntranceDestination_Params
{
public:
...
struct IInterface_QtnGoal_SP_Day1_AmbushParent_C_DoGetGate_Params
{
public:
	class ATravelVolume_BP_C*                    Gate;                                              // 0x0(0x8)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
