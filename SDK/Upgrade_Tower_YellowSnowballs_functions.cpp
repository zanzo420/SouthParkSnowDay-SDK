...
class UClass* UUpgrade_Tower_YellowSnowballs_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Upgrade_Tower_YellowSnowballs_C");

	return Clss;
}


// Upgrade_Tower_YellowSnowballs_C Upgrade_Tower_YellowSnowballs.Default__Upgrade_Tower_YellowSnowballs_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUpgrade_Tower_YellowSnowballs_C* UUpgrade_Tower_YellowSnowballs_C::GetDefaultObj()
{
	static class UUpgrade_Tower_YellowSnowballs_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUpgrade_Tower_YellowSnowballs_C*>(UUpgrade_Tower_YellowSnowballs_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Upgrade_Tower_YellowSnowballs.Upgrade_Tower_YellowSnowballs_C.OnSlottedEvent
...
void UUpgrade_Tower_YellowSnowballs_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_YellowSnowballs_C", "OnSlottedEvent");

	Params::UUpgrade_Tower_YellowSnowballs_C_OnSlottedEvent_Params Parms{};
...
// Function Upgrade_Tower_YellowSnowballs.Upgrade_Tower_YellowSnowballs_C.OnUnslottedEvent
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
...
void UUpgrade_Tower_YellowSnowballs_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_YellowSnowballs_C", "OnUnslottedEvent");

	Params::UUpgrade_Tower_YellowSnowballs_C_OnUnslottedEvent_Params Parms{};
...
// Function Upgrade_Tower_YellowSnowballs.Upgrade_Tower_YellowSnowballs_C.OnUpgradeRolledDataChangedEvent
...
void UUpgrade_Tower_YellowSnowballs_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_YellowSnowballs_C", "OnUpgradeRolledDataChangedEvent");

	Params::UUpgrade_Tower_YellowSnowballs_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
// Function Upgrade_Tower_YellowSnowballs.Upgrade_Tower_YellowSnowballs_C.ExecuteUbergraph_Upgrade_Tower_YellowSnowballs
