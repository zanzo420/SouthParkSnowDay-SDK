...
// BlueprintGeneratedClass VampiricSickles.VampiricSickles_C
// (Actor)

class UClass* AVampiricSickles_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("VampiricSickles_C");

	return Clss;
}


// VampiricSickles_C VampiricSickles.Default__VampiricSickles_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AVampiricSickles_C* AVampiricSickles_C::GetDefaultObj()
{
	static class AVampiricSickles_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AVampiricSickles_C*>(AVampiricSickles_C::StaticClass()->DefaultObject);
...
void AVampiricSickles_C::HandleUnequip_Derived(class AQtnBodyPawn* bodyPawn)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("VampiricSickles_C", "HandleUnequip_Derived");

	Params::AVampiricSickles_C_HandleUnequip_Derived_Params Parms{};
...
void AVampiricSickles_C::HandleEquip_Derived(class AQtnBodyPawn* bodyPawn)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("VampiricSickles_C", "HandleEquip_Derived");

	Params::AVampiricSickles_C_HandleEquip_Derived_Params Parms{};
...
void AVampiricSickles_C::AddMeshForRender(class UStaticMesh* In_Mesh, class AActor* In_Owner, class UStaticMeshComponent** Out_Mesh, class UStaticMeshComponent* L_StaticMesh, const struct FTransform& Temp_struct_Variable, class UStaticMeshComponent* CallFunc_AddComponent_ReturnValue, bool CallFunc_SetStaticMesh_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("VampiricSickles_C", "AddMeshForRender");

	Params::AVampiricSickles_C_AddMeshForRender_Params Parms{};
...
void AVampiricSickles_C::OnAttachItemData(const struct FQtnItemData& ItemData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("VampiricSickles_C", "OnAttachItemData");

	Params::AVampiricSickles_C_OnAttachItemData_Params Parms{};
