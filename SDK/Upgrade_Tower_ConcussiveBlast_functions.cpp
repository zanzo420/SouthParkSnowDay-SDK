...
class UClass* UUpgrade_Tower_ConcussiveBlast_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Upgrade_Tower_ConcussiveBlast_C");

	return Clss;
}


// Upgrade_Tower_ConcussiveBlast_C Upgrade_Tower_ConcussiveBlast.Default__Upgrade_Tower_ConcussiveBlast_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUpgrade_Tower_ConcussiveBlast_C* UUpgrade_Tower_ConcussiveBlast_C::GetDefaultObj()
{
	static class UUpgrade_Tower_ConcussiveBlast_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUpgrade_Tower_ConcussiveBlast_C*>(UUpgrade_Tower_ConcussiveBlast_C::StaticClass()->DefaultObject);
...
void UUpgrade_Tower_ConcussiveBlast_C::CalculateDamageValues(class UQtnUpgradeSlot* OwningSlot, class UQtnVerb* SourceVerb, class AActor* TargetActor, float InBaseDamage, TSubclassOf<class UQtnDamageType> DamageType, float* OutDamageScalar, float* OutBonusDamage, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_ConcussiveBlast_C", "CalculateDamageValues");

	Params::UUpgrade_Tower_ConcussiveBlast_C_CalculateDamageValues_Params Parms{};
...
void UUpgrade_Tower_ConcussiveBlast_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_ConcussiveBlast_C", "OnSlottedEvent");

	Params::UUpgrade_Tower_ConcussiveBlast_C_OnSlottedEvent_Params Parms{};
...
void UUpgrade_Tower_ConcussiveBlast_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_ConcussiveBlast_C", "OnUnslottedEvent");

	Params::UUpgrade_Tower_ConcussiveBlast_C_OnUnslottedEvent_Params Parms{};
...
void UUpgrade_Tower_ConcussiveBlast_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_Tower_ConcussiveBlast_C", "OnUpgradeRolledDataChangedEvent");

	Params::UUpgrade_Tower_ConcussiveBlast_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
