...
// BlueprintGeneratedClass GreatSword_ChargingTechnique.GreatSword_ChargingTechnique_C
// (None)

class UClass* UGreatSword_ChargingTechnique_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GreatSword_ChargingTechnique_C");

	return Clss;
}


// GreatSword_ChargingTechnique_C GreatSword_ChargingTechnique.Default__GreatSword_ChargingTechnique_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGreatSword_ChargingTechnique_C* UGreatSword_ChargingTechnique_C::GetDefaultObj()
{
	static class UGreatSword_ChargingTechnique_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGreatSword_ChargingTechnique_C*>(UGreatSword_ChargingTechnique_C::StaticClass()->DefaultObject);
...
void UGreatSword_ChargingTechnique_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GreatSword_ChargingTechnique_C", "OnSlottedEvent");

	Params::UGreatSword_ChargingTechnique_C_OnSlottedEvent_Params Parms{};
...
void UGreatSword_ChargingTechnique_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GreatSword_ChargingTechnique_C", "OnUnslottedEvent");

	Params::UGreatSword_ChargingTechnique_C_OnUnslottedEvent_Params Parms{};
...
void UGreatSword_ChargingTechnique_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GreatSword_ChargingTechnique_C", "OnUpgradeRolledDataChangedEvent");

	Params::UGreatSword_ChargingTechnique_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
...
// class UMeleeVerbGreatWeaponCombo_C*CallFunc_GetVerb_ReturnValue                                     (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UMeleeVerbGreatWeaponCombo_C*CallFunc_GetVerb_ReturnValue_1                                   (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UMeleeVerbGreatWeaponCombo_C*CallFunc_GetVerb_ReturnValue_2                                   (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UGreatSword_ChargingTechnique_C::ExecuteUbergraph_GreatSword_ChargingTechnique(int32 EntryPoint, class UQtnUpgradeSlot* K2Node_Event_PreviousSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData, class UQtnUpgradeSlot* K2Node_Event_OwningSlot, const struct FQtnRolledUpgradeData& K2Node_Event_PreviousRolledData, const struct FQtnRolledUpgradeData& K2Node_Event_NewRolledData, class AQtnItem* CallFunc_GetOwningItem_ReturnValue, float CallFunc_GetValueOfUpgrade_ReturnValue, class UQtnVerbComponent* CallFunc_GetVerbComponent_ReturnValue, class AQtnItem* CallFunc_GetOwningItem_ReturnValue_1, class UMeleeVerbGreatWeaponCombo_C* CallFunc_GetVerb_ReturnValue, class UQtnVerbComponent* CallFunc_GetVerbComponent_ReturnValue_1, class UMeleeVerbGreatWeaponCombo_C* CallFunc_GetVerb_ReturnValue_1, class UQtnUpgradeSlot* K2Node_Event_TargetSlot, const struct FQtnRolledUpgradeData& K2Node_Event_RolledData_1, bool K2Node_Event_LoadedRunProgress, bool CallFunc_IsValid_ReturnValue, class AQtnItem* CallFunc_GetOwningItem_ReturnValue_2, float CallFunc_GetValueOfUpgrade_ReturnValue_1, class UQtnVerbComponent* CallFunc_GetVerbComponent_ReturnValue_2, class UMeleeVerbGreatWeaponCombo_C* CallFunc_GetVerb_ReturnValue_2)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GreatSword_ChargingTechnique_C", "ExecuteUbergraph_GreatSword_ChargingTechnique");

	Params::UGreatSword_ChargingTechnique_C_ExecuteUbergraph_GreatSword_ChargingTechnique_Params Parms{};
