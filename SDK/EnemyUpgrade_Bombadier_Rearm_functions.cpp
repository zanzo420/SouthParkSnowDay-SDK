...
// BlueprintGeneratedClass EnemyUpgrade_Bombadier_Rearm.EnemyUpgrade_Bombadier_Rearm_C
// (None)

class UClass* UEnemyUpgrade_Bombadier_Rearm_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("EnemyUpgrade_Bombadier_Rearm_C");

	return Clss;
}


// EnemyUpgrade_Bombadier_Rearm_C EnemyUpgrade_Bombadier_Rearm.Default__EnemyUpgrade_Bombadier_Rearm_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UEnemyUpgrade_Bombadier_Rearm_C* UEnemyUpgrade_Bombadier_Rearm_C::GetDefaultObj()
{
	static class UEnemyUpgrade_Bombadier_Rearm_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UEnemyUpgrade_Bombadier_Rearm_C*>(UEnemyUpgrade_Bombadier_Rearm_C::StaticClass()->DefaultObject);

	return Default;
}


// Function EnemyUpgrade_Bombadier_Rearm.EnemyUpgrade_Bombadier_Rearm_C.CanEnemyUpgradeBeRolled
