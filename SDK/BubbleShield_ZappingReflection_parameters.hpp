...
struct UBubbleShield_ZappingReflection_C_OnSlottedEvent_Params
{
public:
...
struct UBubbleShield_ZappingReflection_C_OnUnslottedEvent_Params
{
public:
...
struct UBubbleShield_ZappingReflection_C_OnUpgradeRolledDataChangedEvent_Params
{
public:
...
struct UBubbleShield_ZappingReflection_C_ExecuteUbergraph_BubbleShield_ZappingReflection_Params
{
public:
	...
	class UQtnVerb*                              CallFunc_GetOwningVerb_ReturnValue_1;              // 0xE8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UBubbleShieldVerb_C*                   K2Node_DynamicCast_AsBubble_Shield_Verb;           // 0xF0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0xF8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_75B4[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UBubbleShieldVerb_C*                   K2Node_DynamicCast_AsBubble_Shield_Verb_1;         // 0x100(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UBubbleShieldVerb_C*                   K2Node_DynamicCast_AsBubble_Shield_Verb_2;         // 0x1E0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
