...
struct UQueryContextPerceivedTargetLocation_C_ProvideSingleLocation_Params
{
public:
	...
	struct FVector                               CallFunc_GetPerceivedTargetLocation_ReturnValue;   // 0x38(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
