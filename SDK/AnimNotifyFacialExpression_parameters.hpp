...
// 0x29 (0x29 - 0x0)
// Function AnimNotifyFacialExpression.AnimNotifyFacialExpression_C.Received_NotifyEnd
struct UAnimNotifyFacialExpression_C_Received_NotifyEnd_Params
{
public:
	...
	class UFacialAnimComponent_C*                CallFunc_GetComponentByClass_ReturnValue;          // 0x20(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x28(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

// 0x29 (0x29 - 0x0)
// Function AnimNotifyFacialExpression.AnimNotifyFacialExpression_C.Received_NotifyBegin
struct UAnimNotifyFacialExpression_C_Received_NotifyBegin_Params
{
public:
	class USkeletalMeshComponent*                MeshComp;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                     Animation;                                         // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
