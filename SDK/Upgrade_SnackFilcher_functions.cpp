...
// BlueprintGeneratedClass Upgrade_SnackFilcher.Upgrade_SnackFilcher_C
// (None)

class UClass* UUpgrade_SnackFilcher_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Upgrade_SnackFilcher_C");

	return Clss;
}


// Upgrade_SnackFilcher_C Upgrade_SnackFilcher.Default__Upgrade_SnackFilcher_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUpgrade_SnackFilcher_C* UUpgrade_SnackFilcher_C::GetDefaultObj()
{
	static class UUpgrade_SnackFilcher_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUpgrade_SnackFilcher_C*>(UUpgrade_SnackFilcher_C::StaticClass()->DefaultObject);
...
void UUpgrade_SnackFilcher_C::OnSlottedEvent(class UQtnUpgradeSlot* TargetSlot, struct FQtnRolledUpgradeData& RolledData, bool LoadedRunProgress)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_SnackFilcher_C", "OnSlottedEvent");

	Params::UUpgrade_SnackFilcher_C_OnSlottedEvent_Params Parms{};
...
void UUpgrade_SnackFilcher_C::OnUnslottedEvent(class UQtnUpgradeSlot* PreviousSlot, struct FQtnRolledUpgradeData& RolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_SnackFilcher_C", "OnUnslottedEvent");

	Params::UUpgrade_SnackFilcher_C_OnUnslottedEvent_Params Parms{};
...
void UUpgrade_SnackFilcher_C::OnUpgradeRolledDataChangedEvent(class UQtnUpgradeSlot* OwningSlot, struct FQtnRolledUpgradeData& PreviousRolledData, struct FQtnRolledUpgradeData& NewRolledData)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Upgrade_SnackFilcher_C", "OnUpgradeRolledDataChangedEvent");

	Params::UUpgrade_SnackFilcher_C_OnUpgradeRolledDataChangedEvent_Params Parms{};
